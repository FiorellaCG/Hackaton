...
const Sidebar = ({ isSidebarOpen, setSidebarOpen }) => {
    ...
    let dashboardPath = '/';
    if (isEmpresa) dashboardPath = '/empresa/dashboard';
    else if (isInstitucion) dashboardPath = '/institucion/dashboard';
    else if (usuario?.rol === 'aspirante') dashboardPath = '/dashboard-aspirante';
    else if (usuario?.rol === 'admin') dashboardPath = '/admin';
    ...
    const navLinksAspirante = [
        ...
        { path: "/ajustes", icon: Settings, label: t('sidebar.settings') },
    ...
    const navLinksEmpresa = [
        ...
        { path: "/empresa/dashboard/ajustes", icon: Settings, label: t('sidebar.settings') },
    ...
    const navLinksInstitucion = [
        { path: dashboardPath, icon: LayoutDashboard, label: 'Panel Principal' },
