              ...
              <div className="space-y-2 sm:col-span-2">
                ...
                <div className="flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border-2 border-dashed border-slate-200 dark:border-slate-700 hover:border-green-500 transition-all group relative">
                  ...
                  <div className="flex-1">
                    <p className="text-xs font-bold text-slate-500 mb-1">Sube una foto desde tu equipo</p>
                    <p className="text-[10px] text-slate-400 mb-2">JPG, PNG o GIF. Máx 5MB.</p>
                    <input
                      type="file"
                      name="foto_url"
                ...
                <div className="space-y-4">
                  ...
                  {form.experiencia.length === 0 && (
                    <div className="text-center py-6 border-2 border-dashed border-slate-200 rounded-2xl text-slate-400">
                      <p className="text-xs">No has agregado experiencia laboral todavía.</p>
                    </div>
                  )}
                </div>
              </div>
        ...
        {paso === 3 && (
          <div className="animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="flex items-center gap-3 mb-8 pb-4 border-b border-slate-100">
              ...
              <div>
                <h3 className="text-2xl font-bold text-slate-800">Tus Habilidades</h3>
                <p className="text-slate-500 text-sm">Selecciona tus fortalezas y toca el icono para saber más</p>
              </div>
            </div>

            <div className="space-y-8 mb-10">
              <div>
                <h4 className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-4">Habilidades Técnicas</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-4">Habilidades Blandas</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
