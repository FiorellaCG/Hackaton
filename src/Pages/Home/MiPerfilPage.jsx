    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <main className="flex-1 w-full lg:ml-64 p-6 flex flex-col min-h-screen transition-all">
        ...
        <div className="flex justify-between items-center mb-10 w-full pl-12 lg:pl-0">
          <div>
            <h1 className="text-2xl font-bold text-slate-800 tracking-tight">Configuración de Perfil</h1>
            <p className="text-sm text-slate-500">Zona Franca La Lima, Cartago</p>
          </div>
